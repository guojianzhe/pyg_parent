...
public class BuyCartController {
     ...
     * 添加商品到购物车
     *
     * @CrossOrigin  注解相当于设置了相应头信息,是w3c支持的一种跨域解决方案
     * origins 属性设置的地址,返回响应给静态页面,静态页面所在服务器地址,也即是service_page项目地址
     *
     *
     * @param itemId  商品库存id
     * @param num     购买数量
    ...
    public Result addGoodsToCartList(Long itemId, Integer num){
        ...
        try {
            ...
            if("anonymousUser".equals(username)){
                ...
                CookieUtil.setCookie(request,response, Constants.CART_LIST_COOKIE, JSON.toJSONString(cartList),60*60*24*7,"utf-8");
